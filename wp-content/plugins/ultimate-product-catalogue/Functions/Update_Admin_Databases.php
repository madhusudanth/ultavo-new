...
function Add_UPCP_Category($Category_Name, $Category_Description = "", $Category_Short_Description = "", $Category_Type = "", $Category_Brand_Link = "", $Category_Image = "", $Category_Logo = "", $Category_White_Logo, $WC_Update = "No", $WC_term_id = 0) {
		global $wpdb;
		...
		$wpdb->insert($categories_table_name,
				array( 'Category_Name' => $Category_Name,
						...
						'Category_Brand_Link' => $Category_Brand_Link,
						'Category_Image' => $Category_Image,
						'Category_Logo' => $Category_Logo,
						'Category_White_Logo' => $Category_White_Logo,
...
function Edit_UPCP_Category($Category_ID, $Category_Name, $Category_Description = "", $Category_Short_Description = "", $Category_Type = "", $Category_Brand_Link = "", $Category_Image = "", $Category_Logo = "", $Category_White_Logo, $WC_Update = "No", $WC_term_id = 0) {
		global $wpdb;
		global $categories_table_name;
...
function Update_UPCP_Options() {
	...
	if (isset($_POST['show_category_short_descriptions'])) {update_option("UPCP_Show_Category_Short_Descriptions", $_POST['show_category_short_descriptions']);}
	if (isset($_POST['show_category_type'])) {update_option("UPCP_Show_Category_Type", $_POST['show_category_type']);}
	if (isset($_POST['show_category_brand_link'])) {update_option("UPCP_Show_Category_Brand_Link", $_POST['show_category_brand_link']);}
	...
	if (isset($_POST['display_category_logo'])) {update_option("UPCP_Display_Category_Logo", $_POST['display_category_logo']);}
	if (isset($_POST['display_category_white_logo'])) {update_option("UPCP_Display_Category_White_Logo", $_POST['display_category_white_logo']);}
	...
	if ($Full_Version == "No" and isset($_POST['categories_control_type'])) {update_option("UPCP_Categories_Control_Type", 'Radio'); }
