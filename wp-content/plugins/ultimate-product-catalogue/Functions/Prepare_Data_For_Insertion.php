...
function Add_Edit_Category() {
		...
		$Category_Short_Description = stripslashes_deep($_POST['Category_Short_Description']);
		$Category_Type = stripslashes_deep($_POST['Category_Type']);
		$Category_Brand_Link = stripslashes_deep($_POST['Category_Brand_Link']);
		$Category_Image = stripslashes_deep($_POST['Category_Image']);
		$Category_Logo = stripslashes_deep($_POST['Category_Logo']);
		$Category_White_Logo = stripslashes_deep($_POST['Category_White_Logo']);
		$Category_ID = $_POST['Category_ID'];
		$WC_Update = "No";
		...
		if (!isset($error)) {
				...
				if ($_POST['action'] == "Add_Category") {
					  $user_update = Add_UPCP_Category($Category_Name, $Category_Description, $Category_Short_Description, $Category_Type, $Category_Brand_Link, $Category_Image, $Category_Logo, $Category_White_Logo);
				}
				/* Pass the data to the appropriate function in Update_Admin_Databases.php to edit the category */
				else {
						$user_update = Edit_UPCP_Category($Category_ID, $Category_Name, $Category_Description, $Category_Short_Description, $Category_Type, $Category_Brand_Link, $Category_Image, $Category_Logo, $Category_White_Logo, $WC_Update, $WC_term_id);
				}
				$user_update = array("Message_Type" => "Update", "Message" => $user_update);
				return $user_update;
		}
