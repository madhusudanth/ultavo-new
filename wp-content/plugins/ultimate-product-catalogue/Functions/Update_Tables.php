...
function UpdateTables() {
	...
	/* Update the categories table */  
   	$sql = "CREATE TABLE $categories_table_name (
		...
		Category_Short_Description text DEFAULT '' NOT NULL,
		Category_Type text DEFAULT '' NOT NULL,
		Category_Brand_Link text DEFAULT '' NOT NULL,
		Category_Image text DEFAULT '' NOT NULL,
		Category_Logo text DEFAULT '' NOT NULL,
		Category_White_Logo text DEFAULT '' NOT NULL,
	...
	if (get_option("UPCP_Show_Category_Short_Descriptions") == "") {update_option("UPCP_Show_Category_Short_Descriptions", "No");}
	if (get_option("UPCP_Show_Category_Type") == "") {update_option("UPCP_Show_Category_Type", "No");}
	if (get_option("UPCP_Show_Category_Brand_Link") == "") {update_option("UPCP_Show_Category_Brand_Link", "No");}
	...
	if (get_option("UPCP_Display_Category_Logo") == "") {update_option("UPCP_Display_Category_Logo", "No");}
	if (get_option("UPCP_Display_Category_White_Logo") == "") {update_option("UPCP_Display_Category_White_Logo", "No");}
