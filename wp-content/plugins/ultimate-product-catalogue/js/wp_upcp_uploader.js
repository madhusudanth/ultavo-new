...
jQuery(document).ready(function($){
    ...
    jQuery('#Category_Logo_Button').click(function(e) {
        ...
        custom_uploader.on('select', function() {
            attachment = custom_uploader.state().get('selection').first().toJSON();
            jQuery('#Category_Logo').val(attachment.url);
        });
...
jQuery(document).ready(function($){
    ...
    jQuery('#Category_White_Logo_Button').click(function(e) {
        ...
        custom_uploader.on('select', function() {
            attachment = custom_uploader.state().get('selection').first().toJSON();
            jQuery('#Category_White_Logo').val(attachment.url);
        });
