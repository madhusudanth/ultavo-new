...
function UPCP_Ajax_Filter(AddResults) {
	...
	jQuery.post(ajaxurl, data, function(response) {
		...
		if (parsed_response.request_count == RequestCount) {
			...
			else {jQuery('.prod-cat-inner').html(parsed_response.message);jQuery('#main .entry-header').css('background-image', 'url(' + parsed_response.header_bg_img + ')');jQuery('#main .entry-header .entry-title').text(parsed_response.cat_name);}
